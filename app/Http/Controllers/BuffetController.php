...
class BuffetController extends Controller
{
    ...
    public function show(Buffet $buffet, Request $request)
    {
        ...
        $buffet = $this->buffet->with(['owner', 'owner.user_phone1','owner.user_phone2', 'owner.user_address', 'buffet_phone1', 'buffet_phone2', 'buffet_address'])->find($request->buffet)->first();
    ...
    public function destroy(Request $request)
    {
        ...
        if (!$buffet = $this->buffet->with('owner')->find($request->buffet)->first()) {
