                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b-2 border-gray-200">
                                <tr>
                                    ...
                                    <th class="p-3 text-sm font-semibold tracking-wide text-center">Quantidade de Permissões</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr>
                                    ...
                                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center font-bold">{{ count($role->permissions)}}</td>
