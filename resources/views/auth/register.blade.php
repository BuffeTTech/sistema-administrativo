                    ...
                    <div class="p-6 bg-gray-50 rounded-lg shadow-md ">
                        <form role="form" method="POST" action="{{ route('register') }}" id="form">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <label for="link-checkbox" class="ms-2 text-sm font-medium text-gray-900">Eu concordo com os <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline">termos e condições</a>.</label>
                            </div>
