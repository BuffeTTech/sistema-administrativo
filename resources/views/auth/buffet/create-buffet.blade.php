            ...
            <div class="w-full md:w-1/2 h-screen bg-white flex justify-center items-center rounded-l-lg overflow-y-auto">
                <div class="w-3/4 h-screen px-4 py-16">
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg shadow-md ">
                        <form role="form" method="POST" action="{{ route('auth.buffet.store') }}" id="form">
                            @csrf
                            @method('post')
                            
                            <h5 class="font-bold">Informações do buffet</h5>
                            
                            <div class="mt-2">
                                <x-input-label for="trading_name" :value="__('Nome comercial*')"/>
                            ...
                            <div class="mt-4">
                                <x-input-label for="email_buffet" :value="__('E-mail comercial*')"/>
                            ...
                            <div class="mt-4">
                                <x-input-label for="document_buffet" :value="__('Documento do buffet*')"/>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input-helper>Será o link de acesso de seu buffet, como por exemplo https://buffettech.com.br/seu-buffet</x-helper-input>
                            </div>
                            <h5 class="font-bold mt-4">Informações do buffet</h5>
                            <div class="mt-2">
                            ...
                            <div class="mt-4">
                                <x-input-label for="phone1_buffet" :value="__('Telefone 1*')"/>
                            ...
                            <div class="mt-4">
                                <x-input-label for="phone2_buffet" :value="__('Telefone')"/>
                            ...
                            <div class="text-center mt-4">
                                <button 
                                    type="submit" 
                                    class="w-full py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300"
                                >
                                    Próxima etapa
                                </button>
                            </div>
