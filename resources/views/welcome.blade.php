                ...
                <section class="flex items-center justify-center h-[calc(90vh-180px)]">
                    <div class="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-center z-10">
                        ...
                        <div class="w-full lg:w-1/2 text-white text-center lg:text-left">
                            ...
                            <a href="#saiba-mais" class="bg-yellow-500 text-white px-6 py-3 rounded hover:bg-yellow-600">Saiba mais</a>
                        </div>
                  ...
                  <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div class="lg:pr-8 lg:pt-4">
                      <div class="lg:max-w-lg">
                        <h2 class="text-base/7 font-semibold text-indigo-600">Sobre o BuffeTTech</h2>
                        ...
                        <dl class="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                          <div class="relative pl-9">
                            <dt class="inline font-semibold text-gray-900">
                                <svg class="w-6 absolute left-1 top-1 size-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <div class="overflow-hidden bg-white py-12 sm:pt-12 sm:pb-12">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <!-- Imagem à esquerda -->
                        <img 
                        src="{{ asset('img/dashboard_landingpage.png') }}" 
                        ...
                        <div class="lg:pl-8 lg:pt-4">
                            <div class="lg:max-w-lg">
                                <h2 class="text-base/7 font-semibold text-indigo-600">Benefícios para o Buffet</h2>
        ...
        <section id="planos">
            <div class="relative isolate bg-white px-6 py-12 sm:py-12 lg:px-8">
                ...
                <div class="mx-auto max-w-4xl text-center">
                  <h2 class="text-base/7 font-semibold text-indigo-600">Preços</h2>
