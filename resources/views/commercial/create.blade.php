<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-3xl font-bold mb-4">Cadastrar comercial</h1>
                    <form method="POST" action="{{ route('commercial.store') }}" id="form">
                        ...
                        <div class="mt-2">
                            ...
                            <x-text-input id="phone1" class="phones block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="text" name="phone1" :value="old('phone1')" required autofocus placeholder="Telefone"/>
    ...
    <script>
        ...
        form.addEventListener('submit', async function (e) {
            ...
            const userConfirmed = await confirm(`Deseja cadastrar este comercial?`)
