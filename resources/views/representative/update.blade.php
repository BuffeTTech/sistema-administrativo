                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('representative.update', ['representative'=>$representative->id]) }}" id="form">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="text" name="name" :value="$representative->user->name" required autofocus placeholder="Nome"/>
                        ...
                        <div class="mt-2">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="email" name="email" :value="$representative->user->email" required placeholder="E-mail"/>
                        ...
                        <div class="mt-2">
                            ...
                            <x-select name="document_type" id="document_type" class="block mt-1 w-full dark:bg-slate-100 dark:text-slate-500">
                                <option value="CPF" {{ $representative->user->document_type == "CPF" ? 'selected' : '' }}>CPF</option>
                                <option value="CNPJ {{ $representative->user->document_type == "CNPJ" ? 'selected' : '' }}">CNPJ</option>
                            </x-select>
                        ...
                        <div class="mt-2">
                            ...
                            <x-text-input id="document" class="block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="text" name="document" :value="$representative->user->document" required autofocus placeholder="Documento"/>
                        ...
                        <div class="mt-2">
                            ...
                            <x-text-input id="phone1" class="phones block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="text" name="phone1" :value="$representative->user->user_phone1->number ?? ''" required autofocus onkeypress="mascaraMutuario(this,cpfCnpj)" placeholder="Telefone"/>
                            <x-input-error :messages="$errors->get('phone1')" class="mt-2" />
                        </div>
                        <div class="mt-2">
                            <x-input-label for="phone2" :value="__('Telefone')" class="dark:text-slate-800"/>
                            <x-text-input id="phone2" class="phones block mt-1 w-full dark:bg-slate-100 dark:text-slate-500" type="text" name="phone2" :value="$representative->user->user_phone2->number ?? ''" autofocus onkeypress="mascaraMutuario(this,cpfCnpj)" placeholder="Telefone"/>
